...
Организовал взаимодействие frontend с микросервисной архитектурой компании через REST API.`,
            stack: "TypeScript, Vue 3, Nuxt 3, Pinia, Vuetify, MS SQL, C#",
          },
          {
...
Работал в тесной связке с backend-разработчиком, внедрял компонентный подход во frontend, обеспечивая повторное использование UI-элементов.`,
            stack: "JavaScript, Vue 2, Nuxt, Vuex, Vuetify, MS SQL, C#",
          },
          {
